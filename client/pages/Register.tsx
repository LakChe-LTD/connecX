...
export default function Register() {
  ...
  const [selectedRole, setSelectedRole] = useState<"user" | "operator">("user");
        ...
        <div className="bg-white dark:bg-black rounded-3xl shadow-2xl p-10">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative">
              <select
                value={selectedRole}
                onChange={(e) => setSelectedRole(e.target.value as "user" | "operator")}
          ...
          <div className="mb-6">
            <span className={`inline-block px-4 py-1.5 rounded-full text-sm font-medium ${
              ...
              {selectedRole === 'operator' && '⚙️ Operator Account'}
              {selectedRole === 'user' && '👤 User Account'}
            </span>
          </div>
