    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 bg-white p-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold text-gray-800">Step 1: Device Connection</h2>
          ...
          <div className="mb-8">
            <div className="flex items-start gap-3 mb-6">
              ...
              <div>
                <h3 className="font-medium text-gray-800 mb-1">Connect Your Device</h3>
            ...
            {/* Available Devices */}
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-3">Available Devices</h4>
              <div className="space-y-2">
                <div className="border border-gray-200 rounded-lg p-3 hover:border-blue-300 transition-colors cursor-pointer">
                  <div className="font-medium text-gray-800 text-sm">Hotspot_Device_323</div>
                  <div className="text-xs text-gray-500">Signal Strength: Excellent</div>
                </div>
                <div className="border border-gray-200 rounded-lg p-3 hover:border-blue-300 transition-colors cursor-pointer">
                  <div className="font-medium text-gray-800 text-sm">Hotspot_Device_323</div>
                  <div className="text-xs text-gray-500">Signal Strength: Excellent</div>
          ...
          {/* Continue Button */}
          <button className="bg-black text-white px-6 py-2.5 rounded text-sm font-medium hover:bg-gray-800 transition-colors flex items-center gap-2">
        ...
        <div className="w-80 bg-gray-50 border-l border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-6">Setup Progress</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-500">Network Configuration</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-500">Security Setup</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-500">Authentication Confirmation</span>
            </div>
          </div>
      ...
      <div className="bg-white border-t border-gray-200 px-6 py-3 flex items-center justify-between">
        ...
        <button className="bg-gray-900 text-white px-4 py-1.5 rounded text-xs hover:bg-gray-800 transition-colors">
          Need Help?
        </button>
      </div>
    </div>
